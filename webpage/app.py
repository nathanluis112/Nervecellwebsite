...
st.set_page_config(page_title="nervecell", page_icon="🧠",layout="wide")

#ASSETS
CellBody = Image.open("webpage/images/factory.png")
Nucleus = Image.open("webpage/images/manager.png")
Dendrites = Image.open("webpage/images/mailbox.png")
Axons = Image.open("webpage/images/mailman.png")
Mye = Image.open("webpage/images/marshmallow.png")
Syn = Image.open("webpage/images/hose.png")
Mito = Image.open("webpage/images/engine.png")
ER = Image.open("webpage/images/line.png")
Gol = Image.open("webpage/images/Package.png")
Rib = Image.open("webpage/images/engineer.png")
Lys = Image.open("webpage/images/waste.png")
Nod = Image.open("webpage/images/rest.png")

#HEADER#
with st.container():
    st.subheader("Group 1 12B")
    st.title("Nerve cells")
    st.write("A website that provides information on the parts of a nerve cell")
